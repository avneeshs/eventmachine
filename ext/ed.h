...
class EventableDescriptor: public Bindable_t
{
	public:
		...
		virtual int GetPeerVerifyResult(std::string *err) {return 0;}
		#endif
...
class ConnectionDescriptor: public EventableDescriptor
{
	public:
		...
		virtual void StartTls();
		virtual void SetTlsParms (const char *privkey_filename, const char *certchain_filename, bool verify_peer, const char *ca_filename, int verify_depth);

		#ifdef WITH_SSL
		virtual X509 *GetPeerCert();
		virtual int GetPeerVerifyResult(std::string *err);
