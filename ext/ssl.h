...
{
	public:
		SslContext_t (bool is_server, const string &privkeyfile, const string &certchainfile, const string &cafile);
...
{
	public:
		SslBox_t (bool is_server, const string &privkeyfile, const string &certchainfile, bool verify_peer, const string &cafile, int verify_depth, const unsigned long binding);
		virtual ~SslBox_t();
